...
const Footer = () => {
  return (
    <div className="w-full page-footer bg-white dark:bg-jacarta-900 bottom-0 left-0 block">
      <div className="container">
        ...
        <div className="flex flex-col items-center justify-between space-y-2 py-8 sm:flex-row sm:space-y-0">
          <span className="text-sm dark:text-jacarta-400">
            &copy; 2023 Rarfinite — Built during{" "}
            <a href="https://fantomq22023.devpost.com/?ref_content=online-hackathons&ref_feature=challenge&ref_medium=blockchain-channel" target="_blank" className="text-accent">
