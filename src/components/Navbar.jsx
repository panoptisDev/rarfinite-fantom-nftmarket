...
const Navbar = ({
  ...
  const optInToChannel = async () => {
    await PushAPI.channels.subscribe({
      env: "staging",
      signer: signer,
      channelAddress: `eip155:${chainIdMain}:${Rarfinite_CHANNEL_ADDRESS}`,
  ...
  const getNotifications = () => {
    PushAPI.user
      ...
      .then((feeds) => {
        ...
        if (feeds[0]?.app != "Rarfinite Marketplace") {
                  ...
                  <div className="relative mr-2 z-[100]">
                    ...
                    {showNotifications && (
                      <div className="absolute right-[-50px] z-20 w-64 mt-6 overflow-hidden origin-top-right bg-white rounded-md shadow-xl sm:w-80 dark:bg-gray-800">
                        ...
                        {notificationData && notificationData[0]?.app != "Rarfinite Marketplace" && (
                            ...
                            >
                              <p className="mx-2 text-sm text-black flex flex-col">
                                ...
                                >
                                  ...
                                  susbcribe the Rarfinite marketplace notification
